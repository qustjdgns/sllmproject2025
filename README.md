...
[허깅페이스 해당 모델 관련 url] https://huggingface.co/maywell/Synatra-42dot-1.3B
...
정확한 정보를 제공 하고 있으나, 응답에 불필요한 요소(공백, 기호, 기타 단어)등이 같이 포함됨 Ex) 요.,-- 등등
...
(1592년 4월 13일 -> 1592년 7월/일본군에게 포위된 한산도대첩 ->  한산도대첩에서)
...
- 그 이유는 출력예시와 같이 완벽하게 정확한 정보를 구성하지 못하였기 때문에
